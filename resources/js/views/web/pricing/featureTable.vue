                        ...
                        <tr v-for="(feature, featureName) in group" :key="featureName">
                            ...
                            <td v-for="(value, planIndex) in feature" :key="planIndex" class="text-start pa-4">
                                <template v-if="typeof value === 'boolean'">
                                    <v-icon v-if="value" color="primary" class="">mdi-check-circle</v-icon>
...
const features = {
    General: {
        'Dashboard & Insights': [true, true],
        'Auction Overview': ['40 /day', '3,000 /month'],
        'Interest Based': [1, 2],
        'Watched List': ['30 days', 'Unlimited'],
        'Alerted List': [false, true],
        'Vehicle Sales Overview': [false, true]
    },
    // 'Interest Based': {
