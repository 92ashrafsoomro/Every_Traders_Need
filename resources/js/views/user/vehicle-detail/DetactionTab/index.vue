    ...
    <div class="bg-surface border rounded-sm ">
        ...
        <div v-if="vehicleStore && vehicleStore.reauction">
                ...
                color:rgb(var(--v-theme-light_text_on));">
                        ...
                        <div>
                            <div class="text-h6 mt-2  font-weight-bold">
                                ...
                                {{ vehicleStore.vehicle?.variant?.name }}
                                <v-btn :href="`${vehicleStore.vehicle?.inspection_report}`" target="_blank"
                                    class="text-body-2 pa-1 rounded-sm" style="background:rgb(var(--v-theme-primary));">
                                    Report
                                </v-btn>
                ...
                <div class="mt-2  pl-4 bg-background pa-3"
                    ...
                    <div class="d-flex flex-wrap ga-7 ga-lg-0 ga-md-0 mt-6 justify-space-between">
                        <div class="mb-5 mb-lg-0 mb-md-0">
                            ...
                            <div class="mt-2">{{ vehicleStore.vehicle.mileage }} <span
                                    class="text-danger px-1 rounded-sm"
                                    style="background-color: rgb(var(--v-theme-danger),0.2);">+{{ mileageDiff }}</span>
                            </div>
                        </div>
                        <div class="mb-5 mb-lg-0 mb-md-0">
                            <p class="text-body-2 text-capitalize">Grade</p>
                            <p class="pa-2 text-dark grade-circle mt-2"
                                :style="getGradeStyle(vehicleStore.vehicle.grade)">
                        ...
                        <div class="mb-5 mb-lg-0 mb-md-0">
                            ...
                            <div class="mt-2">{{ vehicleStore.vehicle.last_service || "------" }}</div>
                        </div>
                        <div>
                            <div class="text-body-2">MOT Expiry</div>
                            <div class="mt-2">{{ vehicleStore.vehicle.mot_expiry_date || "------" }}</div>
                        </div>
                    </div>
                    ...
                    <div class=" d-flex ga-lg-0 ga-4 flex-wrap mt-4 justify-space-between  ">
                        <div>
                            ...
                            <div class="d-flex flex-wrap mt-2">
                                <span class="mr-2 d-flex flex-wrap"
            ...
            <div class="bg-surface  mt-5 border mb-5">
                ...
                <v-data-table-server :headers="preAucHeaders" :items="auctionHistory" item-key="id" hide-default-footer>
