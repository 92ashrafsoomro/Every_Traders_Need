...
export const useCsvStore = defineStore("CsvStore", {
    ...
    actions: {
        ...
        toggleSidebar(id = null) {
            this.id = id
            this.auctionEditFilter = !this.auctionEditFilter
        },
    async loadVehicle() {
        ...
        try {
            ...
            let res = await AuctionSchedule.csvGet(this.id, {});            
            let data = res.data.data;
            this.platformName = res.data.auction.platform.name
    ...
    async submit() {
        ...
        try {
            ...
            let res = await AuctionSchedule.csvUpdate(this.id, { data: this.data });
    ...
    async handleFile() {
        ...
        try {
            ...
            let res = await AuctionSchedule.getScrap(this.id, {});
            let data = res.data ?? [];
