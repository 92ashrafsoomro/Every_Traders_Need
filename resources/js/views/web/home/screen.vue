<template>
  <v-container fluid class="hero-section d-flex align-center border-b position-relative overflow-hidden pa-0"
    ...
    <v-container fluid class="position-relative " style=" max-width: 1400px; z-index: 1; ">
      <v-row align="center" class="leftText">
        <v-col cols="12" md="6" class="items-center mx-lg-0 mx-auto mt-10 text-center text-lg-start">
          ...
          <div class="d-flex mt-8  w-75 w-lg-100 mx-auto ga-2 justify-start">
            <span class=" ">We analyse:</span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="24" height="24" class=""
          ...
          <div class="w-100  mt-10 lg-mt-6 ml-n4 ml-lg-0 text-center text-lg-start  ">
            ...
            <div class="w-100  mt-2 mt-5 ">
              <ul class="d-flex flex-wrap ga-2 w-100 mb-2 pa-lg-0 pa-4 ml-10 ml-lg-0" style="list-style:none">
                <li v-for="(item, i) in featuresCol1" :key="i" class="d-flex align-center ga-1">
  ...
  " class="hero-image-abs d-none  position-absolute top-1 d-lg-flex ">

      <img :src="currentImage" :key="currentImage" style="background-size: contain;" />
...
import bgDark from '@/assets/images/screen/darkBg.png'
import rightDark from '@/assets/images/screen/darkLeft.png'
import bgLight from '@/assets/images/screen/lightBg.png'
import rightLight from '@/assets/images/screen/lightLeft.png'
...
export default {
  data() {
    return {
      currentIndex: 0,
      theme: null,
      currentThemeName: 'adminLight',
      featuresCol1: [
        'Reauction history',
        'Previous auction results',
        'CAP & AutoTrader valuations',
        'Trade & retail value signals',
        'Unsold & provisional flags',
  ...
  computed: {
    isDarkTheme() {
      return this.currentThemeName === 'adminDark'
    },
  ...
  methods: {
    ...
    toggleTheme() {
      const newTheme = this.currentThemeName === 'adminDark' ? 'adminLight' : 'adminDark'
  ...
  created() {
    ...
    this.currentThemeName = this.theme.global.name.value

    this.$watch(
      () => this.theme.global.name.value,
      (newVal) => {
        this.currentThemeName = newVal
      },
      { immediate: true }
    )
  },
...
@media (min-width: 960px) and (max-width: 1810.98px) {
  .leftText {
