<template>
       <div v-for="(item, index)  in masterStore.models.data" :key="item.id" class="d-flex align-center justify-space-between" >
           <v-checkbox 
    ...
    <div class="py-4">
        <p style="text-decoration: underline ; cursor: pointer;" @click="showAll = !showAll" v-if="masterStore.models.data.length > 10">
