        ...
        <v-col cols="12">
          <div class="d-flex  justify-space-between w-100 mt-4">
            ...
            <div class="w-50 d-flex">
              ...
              <v-btn to="/admin/category/create" color="primary" style="height: 44px;" variant="flat">
...
export default {
  ...
  methods: {
    ...
    async loadItems() {
      this.loading = true;
      try {
        let res = await General.get("/api/cruds/blogCategory", this.filter);
        this.items = res.data;
