                    ...
                    <div class="mb-3 ">
                        <p class="text-body-1 mb-2">Your Current Plan is
                            <span class="activeUnit pa-lg-2 pa-md-2 pa-1 d-inline "> {{
                                userStore.user?.plan?.plan?.plan_name ? userStore.user.plan.plan.plan_name : 'No Plan'
                                }} </span>
                        </p>
                    ...
                    <div class="mt-8">
                        <p class="text-body-1">Active until <span
                                class="activeUnit pa-2 d-lg-inline d-md-inline d-block"> {{
                                    userStore.user?.plan?.membership_expiry_date ?
                                userStore.user.plan.membership_expiry_date : 'No' }}
                            </span> </p>
                        <p class="text-body-2 font-weight-thin mt-2" style="color:rgb(var(--v-theme-light))">We
