                    ...
                    <form class="pt-4" action="{{ url('/interest/') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                <label for="title" class="form-label">Interest Title <span
                                ...
                                <div class="d-flex">
                                    <div class="box w-100">
                                        <select name="year_from" class="form-select">
                                            ...
                                            @foreach ($years as $year)
                                                <option @if (old('year_from') == $year) selected @endif
                                    ...
                                    <div class="box w-100">
                                        <select name="year_to" class="form-select">
                                            ...
                                            @foreach ($years as $year)
                                                <option @if (old('year_to') == $year) selected @endif
                                                    value="{{ $year }}">{{ $year }}</option>
                                            @endforeach
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="fuel_type" class="form-select">
                                    ...
                                    @foreach ($fuel_types as $item)
                                        <option @if ($item == old('fuel_type')) selected @endif
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="fuel_type" class="form-select" type="range">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="transmission" class="form-select">
                                    ...
                                    @foreach ($transmission as $item)
                                        <option @if (old('transmission') == $item) selected @endif
                                            value="{{ $item }}">{{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="grade" class="form-select">
                                    ...
                                    @foreach ($grade as $item)
                                        <option @if (old('grade') == $item) selected @endif
                                            value="{{ $item }}">{{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                priceSteps
                    ...
                    .forEach(p => {
                        ...
                        priceTo.insertAdjacentHTML('beforeend',
                            `<option value="${val}">£${val.toLocaleString()}</option>`);
                    });
            });
            ...
            mileageSteps.forEach(m => {
                mileageFrom.insertAdjacentHTML('beforeend',
                    `<option value="${m}">${m.toLocaleString()} km</option>`);
