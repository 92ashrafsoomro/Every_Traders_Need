<template>
            ...
            <v-row>
                <v-col cols="12" md="6" >
                    <v-text-field
                        ...
                        @click:append-inner="toggle_new_password = !toggle_new_password"
                        variant="outlined"
                        color="primary"
                        density="compact"
                         />
                ...
                <v-col cols="12" md="6" >
                    <v-text-field
                        ...
                        :type="toggle_confirm_Password ? 'text' : 'password'"
                        @click:append-inner="toggle_confirm_Password = !toggle_confirm_Password"
                        variant="outlined"
                        color="primary"
                        density="compact"
                         />
    ...
    <custom-card title="Recent Devices" class="">
        <v-data-table-server class="pb-3" 
            :headers="pageStore.recentDevices.headers" 
            :items="pageStore.recentDevices.data" 
            :items-length="pageStore.recentDevices.total"
            :loading="pageStore.recentDevices.loading" 
            item-value="id"
            >
                ...
                <template v-slot:bottom>
                    <div class="py-2" >
                        <custom-pagination
                        :loading="pageStore.recentDevices.loading"
                        v-model:page="pageStore.recentDevices.page" 
                        :lastPage="pageStore.recentDevices.last_page"
                        />
                    </div>
                </template>
            </v-data-table-server>
