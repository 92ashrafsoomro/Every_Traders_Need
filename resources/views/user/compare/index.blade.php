...
@section('content')
    ...
    <section>
        ...
        <div class="relative w-full h-auto lg:h-[40vh] bg-[#000f21] overflow-hidden space-y-4">
            ...
            <div class="relative z-10 mx-auto pt-10 px-10">
            ...
            <div id="filterSection" class="relative  z-10 px-10">
                    ...
                    <div class="p-5 grid grid-cols-1 lg:grid-cols-4 gap-5 items-center">
                        ...
                        <div>
                            ...
                            <div style="display:flex;gap:0.5rem;align-items:center;margin-top:0.5rem;">
                                <input type="number" name="mileage_from" id="mileage_from" class="form-control"
                                    placeholder="Min"
                                ...
                                <input type="number" name="mileage_to" id="mileage_to" class="form-control"
                                    placeholder="Max"
                                    style="flex:1;padding:0.5rem 0.75rem;border-radius:0.5rem;border:1px solid #4b5563;background:#111827;color:#f3f4f6;font-weight:500;outline:none;">
                            </div>
                            ...
                            <div style="position:relative; height:40px;">
                                ...
                                <input type="range" id="mileage_range_max" min="0" max="500000" value="500000"
                                    step="1000"
                                ...
                                <input type="range" id="mileage_range_min" min="0" max="500000"
                                    value="0" step="1000"
