            ...
            <v-row no-gutters class="mt-3">
                <v-col cols="12">
                    <div class="d-flex flex-wrap ">
                        ...
                        <div class="pl-2" >
                            <v-btn to="/admin/center/create" color="primary" style="height: 44px;" variant="flat" @click="loadItems">
                    ...
                    <div class="border"> 
                        <v-data-table-server 
                            ...
                            <template #item.action="{ item }">
                                <router-link :to="'/admin/center/edit/' + item.id" target="_blank">
    ...
    watch: {
     ...
     methods: {
        ...
        async loadItems() {
                ...
                this.loading = true;
                try {
                    let res = await  Center.all(this.filter);
                    this.items = res.data;
        ...
        async deleteItem(id) {
            ...
            this.loading = true;
            try {
            const res = await Center.delete(id);
      
            this.$alertStore.add(res.message || "Center deleted", "success");
            this.loadItems(); 
