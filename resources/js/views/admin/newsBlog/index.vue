        ...
        <v-col cols="12">
          <div class="d-flex  justify-space-between w-100 mt-4">
            ...
            <div class="w-50 d-flex">
              ...
              <v-btn to="/admin/newsBlog/create" color="primary" style="height: 44px;" variant="flat">
          ...
          <div class="border">
            <v-data-table-server  :loading="loading" :headers="headers" :items="items" :items-length="total" hover
              ...
              <template #item.action="{ item }">
                <div class="d-flex">
                  <router-link :to="'/admin/newsBlog/edit/' + item.id">
...
export default {
  ...
  methods: {
    ...
    async loadItems() {
      this.loading = true;
      try {
        let res = await General.get("/api/cruds/news", this.filter);
        this.items = res.data;
