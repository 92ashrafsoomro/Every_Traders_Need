    ...
    <li
        ...
        <a href="{{ route('ticket.history') }}" class="menu-link space-x-2">
            <span class="material-symbols-outlined">
                support_agent
            </span>
            <div>Support</div>
    ...
    <li class="menu-item {{ request()->is('news*') ? 'active' : 'text-white' }}">
        <a href="{{ route('news.index') }}" class="menu-link space-x-2">
            <span class="material-symbols-outlined">
                newspaper
            </span>
            <div>News</div>
    ...
    <li class="menu-item {{ request()->is('userprofile*') ? 'active' : '' }}">
        <a href="{{ url('userprofile') }}" class="menu-link space-x-2">
            <span class="material-symbols-outlined">
                account_circle
            </span>
            <div>Profile</div>
