...
<div class="row g-6">
    <div class="col-md-12 mt-md-n5 mb-md-4 mt-0 mb-0">
        ...
        <div class="row" style="margin-top: -16px;">
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                <select
                                    style="background-color:black !important;  color:white !important;  height: 40px !important;  overflow-x: auto !important;  overflow-y: hidden !important;   white-space: nowrap !important;   display: flex !important;  align-items: center;"
                                    class="form-control platform" name="paltform_id[]" multiple>
            ...
            <br>
            <!-- Left Side: Stats -->
            <div class="col-md-6 col-12 vehicleStates"
                style="background-color: #000f21; border-radius: 4px; padding: 30px; border: 1px solid #353F4C;">
                <div style="margin-bottom: 60px; ">
                    <h5 class="pb-0 mb-0">Vehicle Statistics </h5>
                    <span class="mt-0 pt-0"
                        style=" font-size: 16px; font-weight: normal; color: #ccc; padding-top: -4px;">Today</span>
                </div>
                ...
                <div class="row">
                    <div class="col-5" style="">
                        ...
                        <div class="legend-item" style="display: flex; align-items: center; margin-bottom: 20px;">
                            ...
                            <span>
                                <span class="" style="font-size: var(--font-h6); color:white;">Provisional
                                </span><br>
        ...
        <div class="row" style=" margin-top: -28px;">
            <div class="col-md-6 col-12 getTimeAuctions">
                <div class="card h-100">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
