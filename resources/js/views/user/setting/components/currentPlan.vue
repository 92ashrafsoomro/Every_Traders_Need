                ...
                <div class="py-3 px-3">
                    ...
                    <div class="w-100">
                        <p class="d-flex justify-space-between">
                            <span class="text-h6">Days</span>
                            <span class="text-h6">16 of 30 Days</span>
                        </p>
                        <div class="py-3" style="width:300px">
                            <v-progress-linear height="7" color="warning" model-value="20"></v-progress-linear>
                        </div>
                        <p class="text-body-2" style="color:rgb(var(--v-theme-light))">16 days remaining until your plan
                            requires update</p>
                    </div>

                    <div class="py-5 ">
                        <div class="mb-3">
                            <p class="text-h6">Your Current Plan is "Free"</p>
                            <p class="text-body-2" style="color:rgb(var(--v-theme-light))">For small dealers.</p>
                        </div>
                        <div>
                            <p class="text-h6">Active until 2025-12-07 11:52:44</p>
                            <p class="text-body-2 font-weight-thin" style="color:rgb(var(--v-theme-light))">We will send
                                you
                    ...
                    <v-container class="d-flex m-2">
                        ...
                        <v-dialog max-width="">
                            <template v-slot:activator="{ props: activatorProps }">
                                <v-btn v-bind="activatorProps" color="primary" text="Price Plain" variant="flat"
                        ...
                        <v-dialog max-width="500">
                            <template v-slot:activator="{ props: activatorProps }">
                                <v-btn v-bind="activatorProps" color="danger" text="Cancle Subscription"
                                    variant="flat"></v-btn>
                            </template>
                            ...
                            <template v-slot:default="{ isActive }">
                                <v-card title="Dialog">
                                    <v-card-text>
                                        Subscription Cancle Succesfully
                                    </v-card-text>
