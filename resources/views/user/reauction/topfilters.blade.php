   ...
   <div class="relative w-full h-auto lg:h-[40vh] bg-[#000f21] overflow-hidden space-y-5">
       ...
       <div
           class="container mx-auto d-flex flex-column flex-md-row justify-content-start align-items-center gap-5 text-center text-md-start">

           <!-- Stats Card -->
           <div class="stats-card text-white px-4 py-3  shadow-sm text-center bg-red-700 z-10">
           ...
           <div class="platform-info text-white">
               ...
               <div class="d-flex align-items-center gap-3 mb-3">
                   <h6 class="mb-0 text-muted capitalize" style="letter-spacing: 0.5px;">Auction House
                   </h6>
                   <div class="platform-badgess platforms-container d-flex flex-wrap gap-2 !ml-1">
                   </div>
               </div>

               <!-- Center Section -->
               <div class="d-flex align-items-center gap-3">
                   <h6 class="mb-0 text-muted" style="letter-spacing: 0.5px;">Center</h6>
                   <div class="platform-badges centers-container d-flex flex-wrap gap-2 ml-16"></div>
               </div>
           </div>
