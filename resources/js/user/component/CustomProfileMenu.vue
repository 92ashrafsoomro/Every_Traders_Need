<template>
  ...
  >
    <!-- Activator: your avatar button -->
    <template #activator="{ props }">
      <div class="relative inline-block" v-bind="props">
        <div class="profile-avatar">
          <img :src="userStore.user?.avatar" alt="Image" />
        </div>
      </div>
    </template>
...
<style scoped>
/* ✅ Copy ALL your existing styles from your original component here — no change needed */
.profile-avatar {
  height: 45px;
  width: 45px;
  border-radius: 50%;
