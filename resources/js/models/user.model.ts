...
export default class UserModel {
    ...
    static fields = [
        ...
        { icon: 'mdi-briefcase-outline',key: "jobTitle", label: "Job Title", type: "text", group: "personal" },
        ...
        { icon: 'mdi-check', key: "businessType", label: "Business Type", type: "text", group: "bussiness" },
        { icon: 'mdi-pound', key: "companyReg", label: "Company Reg", type: "text", group: "bussiness" },
        { icon: 'mdi-email-outline', key: "businessEmail", label: "Business Email", type: "email", group: "bussiness" },
        { icon: 'mdi-map-marker-outline', key: "country", label: "Country", type: "text", group: "bussiness" },
        { icon: 'mdi-map-marker-outline', key: "townCity", label: "Town / City", type: "text", group: "bussiness" },
        { icon: 'mdi-pound', key: "postcode", label: "Postcode", type: "text", group: "bussiness" },
        { icon: 'mdi-store-marker-outline', key: "companyAddress1", label: "Company Address 1", type: "text", group: "bussiness" },
        { icon: 'mdi-store-marker-outline', key: "companyAddress2", label: "Company Address 2", type: "text", group: "bussiness" },
