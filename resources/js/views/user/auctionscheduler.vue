<template>
      <user-title-bar title="Auction Schedule" style="z-index: 1;"
        ...
        <div class="d-lg-none d-md-none d-flex mt-4">
        ...
        <div class="d-flex d-lg-none d-md-none  justify-space-between mt-2" style="width:90.5%;">
            <v-btn icon variant="tonal" color="primary" @click="carousel--">
